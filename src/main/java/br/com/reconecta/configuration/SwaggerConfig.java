package br.com.reconecta.configuration;
...
public class SwaggerConfig {
	...
	private static final String BASE_PACKAGE = "br.com.reconecta.entrypoint";
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("Reconecta API").description("Documentação da API").version("1.0.0")
